...
export {
  ResourceManager,
  browser_utils_exports as browserUtils,
  bundle_entry_default as default,
  dom_utils_exports as domUtils,
  form_utils_exports as formUtils,
  modal_utils_exports as modalUtils,
  template_utils_exports as templateUtils
};
